...
const JobsOffers = () => {
  ...
  const [similpostArray, setSimilpostArray] = useState([
    ...
    },
    {
      ...
      resume:
        "Join our team as a Full-stack Developer and contribute to the development of our web and mobile applications.",
      description:
      ...
      companyLogo:
        "https://img.freepik.com/premium-vector/real-estate-business-logo-design-building-property-development-construction-business_624799-6.jpg?w=360",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
    ...
    },
    {
      ...
      resume:
        "We are hiring a Backend Developer to join our remote team and contribute to the development of our software solutions.",
      description:
        "As a Backend Developer, you will work on the server-side development of our software solutions. You will be responsible for designing and implementing scalable APIs, optimizing database performance, and ensuring smooth integration with front-end systems. Strong knowledge of backend technologies, such as Node.js or Django, is required.",
      companyLogo:
        "https://images-platform.99static.com/8FoUkYeCFkP2qp7_MXbOJdZqqag=/500x500/top/smart/99designs-contests-attachments/4/4740/attachment_4740449",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
    ...
    },
    {
      ...
      resume:
        "We are seeking a talented Front-end Engineer to join our team and contribute to the development of our web and mobile applications.",
      description:
      ...
      companyLogo:
        "https://images-platform.99static.com//Tdvnc9WurW20Byub_9gpnZC-FLY=/0x0:960x960/fit-in/500x500/99designs-contests-attachments/76/76659/attachment_76659193",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
    ...
    },
    {
      ...
      resume:
        "Join our team as a Mobile App Developer and contribute to the development of our iOS and Android applications.",
      description:
        "We are looking for a skilled Mobile App Developer to join our team and help build cutting-edge iOS and Android applications. You will work on the entire mobile app development lifecycle, from concept to deployment, and collaborate with cross-functional teams to deliver high-quality user experiences. Proficiency in Swift or Kotlin is required.",
      companyLogo:
        "https://img.freepik.com/premium-vector/programming-code-technology-logo_617585-1862.jpg",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
    ...
    },
    {
      ...
      resume:
        "We are hiring a Software Engineer to join our remote team and contribute to the development of our software solutions.",
      description:
        "As a Software Engineer, you will work on the design, development, and testing of our software solutions. You will collaborate with cross-functional teams to ensure the successful delivery of high-quality software products. Strong programming skills in languages such as Java, C++, or Python are required.",
    ...
    },
    {
      ...
      resume:
        "Join our team as a UI/UX Designer and contribute to the creation of intuitive and visually appealing web and mobile applications.",
      description:
    ...
    },
    {
      ...
      resume:
        "We are seeking a skilled DevOps Engineer to join our remote team and help streamline our development and deployment processes.",
      description:
        "As a DevOps Engineer, you will work on automating and optimizing our development, testing, and deployment pipelines. You will collaborate with development and operations teams to ensure smooth and efficient software delivery. Strong knowledge of cloud platforms (e.g., AWS, Azure) and experience with CI/CD tools (e.g., Jenkins, GitLab CI) are required.",
      companyLogo: "https://assets.soyhenry.com/logoOG.png",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
    ...
    },
    {
      ...
      resume:
        "Join our team as a Data Scientist and contribute to the development of cutting-edge data-driven solutions.",
      description:
        "As a Data Scientist, you will work on analyzing large datasets, building predictive models, and deriving actionable insights to drive business decisions. You will collaborate with cross-functional teams to develop data-driven solutions and communicate findings to stakeholders. Strong knowledge of statistics, programming languages (e.g., Python, R), and experience with machine learning frameworks (e.g., TensorFlow, PyTorch) are required.",
      companyLogo: "https://assets.soyhenry.com/logoOG.png",
      interviewerImage:
        "https://cdn-icons-png.flaticon.com/512/1661/1661612.png",
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-200 bg-cover">
      ...
      <div className="mt-8 mb-8">
        {showModal && (
          <CreatePostModal addPost={addPost} closeModal={closeModal} />
        )}
