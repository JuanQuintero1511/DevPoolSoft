...
import Profile from '../../../Profile'; // Importa tu componente grande
...
const MyData = () => {
 return (
   <Paper
     sx={{
      width: '85%', // Ancho al 100% de la ventana
      height: '70%', // Altura al 100% de la ventana
       overflow: 'auto', // Añade desplazamiento si el contenido es más grande que el contenedor
       border: '1px solid #ccc', // Añade un borde para visualizar mejor el contenedor
       justifyContent: 'center', //
     }}
   >
     <Profile /> {/* Aquí renderizas tu componente importado */}
   </Paper>
 );
};
