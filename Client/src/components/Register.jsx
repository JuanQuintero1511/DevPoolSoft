            ...
            <div className="w-full sm:w-1/2 px-2">
              <div className="relative mb-2">
                <input
                  ...
                  className="block px-2.5 pb-2.5 pt-4 w-full sm:w-[40%] text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-black font-mono dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  name="password2"
                  onChange={handleInputChange}
                  required
